...
For AWS deployments, this token is generated by CDK and stored in Secrets Manager (`coding-platform/judge0/proxy-token`).
Use CloudFormation output `Judge0ProxyTokenSecretArn` to fetch it.
